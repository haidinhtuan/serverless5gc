...
\node[box, fill=nfblue!8, right=1.2cm of gw, minimum width=2.8cm, minimum height=3.4cm] (r15pool) {};
\node[above=0pt of r15pool.north, font=\scriptsize\bfseries] {R15 Core (21 fn)};
\node[funcbox, fill=nfblue!15] at ([yshift=0.8cm]r15pool.center) (amf) {AMF (6)};
...
% R17 functions
\node[box, fill=r17red!8, right=0.4cm of r15pool, minimum width=2.4cm, minimum height=3.4cm] (r17pool) {};
\node[above=0pt of r17pool.north, font=\scriptsize\bfseries, text=r17red] {R17 (10 fn)};
\node[funcbox, fill=r17red!12] at ([yshift=0.9cm]r17pool.center) (chf) {CHF (3)};
...
\draw[arrow, dashed, r17red] (gw) -- node[above, label, text=r17red] {HTTP} (r17pool.west);

% State arrows
\draw[arrow, nfpurple] ([xshift=-0.3cm]r15pool.south) |- (redis);
\draw[arrow, nfpurple] ([xshift=0.3cm]r15pool.south) |- (etcd);
\draw[arrow, dashed, nfpurple] (r17pool.south) |- ([yshift=0.1cm]redis.east);
\draw[arrow, nfgray] (r15pool.east |- upf.north) -- (upf.north) node[midway, above, label] {PFCP (N4)};
