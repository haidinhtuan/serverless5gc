...
\begin{figure}[t]
    ...
    \begin{axis}[
        ...
        symbolic x coords={Low, High, Burst},
        xtick=data,
        nodes near coords,
        nodes near coords align={vertical},
    ...
    \addplot coordinates { (Low,51) (High,53) (Burst,53) };
    \addlegendentry{Serverless}
    \addplot coordinates { (Low,36) (High,35) (Burst,37) };
    \addlegendentry{Open5GS}
    \addplot coordinates { (Low,45) (High,49) (Burst,31) };
    \addlegendentry{Free5GC}
    \end{axis}
\end{tikzpicture}
